...
import 'subscription_managepage_xplane_monthly_model.dart';
export 'subscription_managepage_xplane_monthly_model.dart';

class SubscriptionManagepageXplaneMonthlyWidget extends StatefulWidget {
  const SubscriptionManagepageXplaneMonthlyWidget({super.key});

  static String routeName = 'subscriptionManagepageXplaneMonthly';
  static String routePath = '/subscriptionManagepageXplaneMonthly';

  @override
  State<SubscriptionManagepageXplaneMonthlyWidget> createState() =>
      _SubscriptionManagepageXplaneMonthlyWidgetState();
}

class _SubscriptionManagepageXplaneMonthlyWidgetState
    extends State<SubscriptionManagepageXplaneMonthlyWidget> {
  late SubscriptionManagepageXplaneMonthlyModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => SubscriptionManagepageXplaneMonthlyModel());
