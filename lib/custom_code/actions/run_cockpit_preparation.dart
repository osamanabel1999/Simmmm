...
Future<void> runCockpitPreparation() async {
  ...
  // القائمة الجديدة مع إتاحة أكثر من رد لـ Fuel Quantity
  List<Map<String, String>> checklist = [
    {'q': 'GEAR PINS and COVER', 'a': 'removed'},
    {'q': 'FUEL QUANTITY', 'a': 'checked|set'}, // يقبل checked أو set
    {'q': 'SEAT BELTS', 'a': 'on'},
    {'q': 'ADIRS', 'a': 'nav'},
  ...
  // البداية
  await flutterTts.speak("COCKPIT PREPARATION CHECK LIST");
  ...
  // النهاية
  await flutterTts.speak("COCKPIT PREPARATION CHECK LIST COMPLETED");
}
