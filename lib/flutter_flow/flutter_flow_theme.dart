...
abstract class FlutterFlowTheme {
  ...
  String get airbusFontFamily => typography.airbusFontFamily;
  TextStyle get airbusFont => typography.airbusFont;
...
abstract class Typography {
  ...
  String get airbusFontFamily;
  TextStyle get airbusFont;
}
...
class ThemeTypography extends Typography {
  ...
  String get airbusFontFamily => 'Airbus';
  TextStyle get airbusFont => TextStyle(
        fontFamily: 'Airbus',
        color: Colors.white,
        fontSize: 16.0,
      );
